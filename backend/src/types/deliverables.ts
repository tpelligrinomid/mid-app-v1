...
export type DeliverableType = 'research' | 'roadmap' | 'seo_audit' | 'content_plan' | 'abm_plan' | 'messaging_plan' | 'points_plan' | 'plan' | 'brief' | 'presentation' | 'other';
...
export const DELIVERABLE_TYPE_VALUES: DeliverableType[] = [
  'research', 'roadmap', 'seo_audit', 'content_plan', 'abm_plan', 'messaging_plan', 'points_plan', 'plan', 'brief', 'presentation', 'other',
];
