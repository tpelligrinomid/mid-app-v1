...
// Sentiment analysis structure (generated by AI from transcript)
...
export interface MeetingSentiment {
  ...
  bullets: string[]; // 5 key takeaways
  highlights: SentimentHighlight[]; // 0-3 notable quotes
  topics: string[]; // 0-6 topic tags
